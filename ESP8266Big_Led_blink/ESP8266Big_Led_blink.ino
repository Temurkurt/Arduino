      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>Smart Sweet Home(Bedirhanin Kerhanesi)</h1>");
            ...
            // Display current state, and ON/OFF buttons for Door
             ...
             if (doorstate=="off") {
              client.println("<p><a href=\"/16/on\"><button class=\"button\">Closed</button></a></p>");
            } else {
              client.println("<p><a href=\"/16/off\"><button class=\"button button2\">Opened</button></a></p>");
            }
